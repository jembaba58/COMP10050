...
int main(void){
	...
	while(p<playerNumber){
		...
		if(move == 1){
			...
			printf("\n\n%s (%s, %d)", player[0].type, player[0].name, lifePoints);
			printf("\n\n%s (%s, %d)", player[1].type, player[1].name, lifePoints);
			printf("\n\n%s (%s, %d)", player[2].type, player[2].name, lifePoints);
			printf("\n\n%s (%s, %d)", player[3].type, player[3].name, lifePoints);
			printf("\n\n%s (%s, %d)", player[4].type, player[4].name, lifePoints);
			printf("\n\n%s (%s, %d)", player[5].type, player[5].name, lifePoints);
